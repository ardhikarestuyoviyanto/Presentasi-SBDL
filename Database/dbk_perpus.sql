...
(1,'Royan Chusain Azhari','L','0876545412','Karanganyar, Jawa Tengah','5190411312','Teknik Informatika'),
...
(8,'Dedi Kusnandar','L','0872621412','Sragen, Jawa Tengah','5190411319','Teknik Industri');
...
(5,'2021-02-10','2021-02-18',4,3,2),
(6,'2021-02-16','2021-02-24',5,3,3),
(7,'2021-02-08','2021-02-18',5,4,3),
(8,'2021-02-22','2021-02-27',6,5,4),
(9,'2021-02-22','2021-02-27',7,6,3),
(10,'2021-02-07','2021-02-13',9,8,2);
...
(2,'2021-02-24',0,2,1),
(3,'2021-02-25',2000,3,2),
(4,'2021-02-25',3000,4,2),
(5,'2021-02-26',6000,5,2);
...
insert  into `petugas`(`id_petugas`,`nama_petugas`,`alamat_petugas`,`notelp_petugas`,`jeniskelamin_petugas`) values 
(1,'Roni Febrianto, S.I.P','Sukoharjo, Jawa Tengah','08762524223','L'),
(2,'Dewi Susanti, S.I.P','Karanganyar, Jawa Tengah','08765241412','P'),
(3,'Dian Seftiana, S.I.P','Karanganyar, Jawa Tengah','08726252525','L'),
(4,'Dimas Santoso, S.I.P','Wonogiri, Jawa Tengah','08525242421','L');
